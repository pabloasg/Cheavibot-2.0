...
class Triangulo:  #define un triangulo dados 3 puntos
    ...
    def dibujar(self):
        pygame.draw.polygon(self.surface, (BLANCO), (self.p1, self.p2, self.p3), 3)
    ...
    def dibujarcir1(self , a, r): #dibuja un circulo con el radio calculado en la funcion 1
        pygame.draw.circle(self.surface, (BLANCO), a, r, 3)
    ...
    def dibujarlrd1(self, pos, R, orientacion): #dibuja los circulos de las LDR, R corresponde al radio del triangulo, pos a las coordenadas del centro del triangulo
        ...
        pygame.draw.line(self.surface, (BLANCO), pos, (b1a, b2a), 3)
        pygame.draw.line(self.surface, (BLANCO), pos, (b1b, b2b), 3)
        pygame.draw.circle(self.surface, (BLANCO), (b1a, b2a), r, 3)
        pygame.draw.circle(self.surface, (BLANCO), (b1b, b2b), r, 3)
        #print(r)
    ...
    def dibvect1(self, centro, R, orientacion): #metodo de prueba dibuja un vector desde el centro a algun vertice
        ...
        puntos=(a,b,c)
        pc=orientacion -1
        pygame.draw.line(self.surface, (BLANCO), centro, puntos[pc], 3)
...
class Chevibot(Triangulo):
    ...
    def dibavance(self, pos, R, orientacion, ncir):  #dibuja 1 circulo en cada LDR o un circulo grande
        ...
        if ncir==1:
            #circulo grande
            r=int(R-R/8)
            pygame.draw.circle(self.surface, (BLANCO), (pos), r, 0)
        else:
    ...
    def dibrotacion(self, pos, R, orientacion, dm1, dm2):
        ...
        b2b=pos[1] - int(l*r*math.sin(c))
        if dm1==1:
            pygame.draw.circle(self.surface, (BLANCO), (b1b, b2b), 3*r, 0) 
        elif dm1==0:
            pygame.draw.circle(self.surface, (BLANCO), (b1a, b2a), 3*r, 0) 
