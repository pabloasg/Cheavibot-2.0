...
s=3 #factor de escalamiento, dice que tan alejados estan los puntos desde su origen, mientras mas alto el numero, menor es la variacion
osi=int(os/2)
...
dl=int(cte*r*1.5) #distancia de interaccion de los bots, este parametro es lo que se usa para resolver el problema de los vecinos cercanos
