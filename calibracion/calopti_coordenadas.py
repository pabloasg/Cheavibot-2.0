...
'''
en este programa se calibran los parametros globales que gobiernan las coordenadas, estos son el origen en x, y, el factor de escala s, que determina el tamano en el cual los bots proyectados coinciden con
los bots reales
'''
