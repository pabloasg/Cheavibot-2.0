...
'''
este archivo es identico a fig (del package dibujos), de forma de poder crear bots desde los datos del optitrack
ya que estos deben ser un grupo de 3 marcadores, que forman un triangulo
'''
...
class Triangulo:  #define un triangulo dados 3 puntos
    ...
    def dibujar(self):
        pygame.draw.polygon(self.surface, (255,255,255), (self.p1, self.p2, self.p3), 1)
    ...
    def circumcentro(self):
        ...
        return (int(ux), int(uy), int(r), int(uxp+a[0]), int(uyp+a[1]))
    ...
    def dibujarcir1(self , a, r): #dibuja un circulo con el radio calculado en la funcion 1
        pygame.draw.circle(self.surface, (255,255,255), a, r, 1)
    ...
    def dibujarlrd1(self, pos, R, orientacion): #dibuja los circulos de las LDR, R corresponde al radio del triangulo, pos a las coordenadas del centro del triangulo
        ...
        #print((math.sin(c)))
        #print((math.cos(c)))     
        b1a=pos[0] + int(l*r*math.cos(c))
        b2a=pos[1] + int(l*r*math.sin(c))
        b1b=pos[0] - int(l*r*math.cos(c))
        b2b=pos[1] - int(l*r*math.sin(c))
        pygame.draw.line(self.surface, (255,255,255), pos, (b1a, b2a), 1)
        pygame.draw.line(self.surface, (255,255,255), pos, (b1b, b2b), 1)
        pygame.draw.circle(self.surface, (255,255,255), (b1a, b2a), r, 1)
        pygame.draw.circle(self.surface, (255,255,255), (b1b, b2b), r, 1)
        #print(r)
    ...
    def dibvect1(self, centro, R, orientacion): #metodo de prueba dibuja un vector desde el centro a algun vertice
        ...
        puntos=(a,b,c)
        pc=orientacion -1
        pygame.draw.line(self.surface, (255,255,255), centro, puntos[pc], 1)
    ...
    def dibcentro(self, centro, R):
        r=int(R/15)
        pygame.draw.circle(self.surface, (255,255,255), (centro), r, 0)
...
class Chevibot(Triangulo):
    ...
    def dibavance(self, pos, R, orientacion, ncir):  #dibuja 1 circulo en cada LDR o un circulo grande
        ...
        if ncir==1:
            #circulo grande
            r=int(R-R/8)
            pygame.draw.circle(self.surface, (0,255,0), (pos), r, 2)
        else:
            ...
            b1b=pos[0] - int(l*r*math.cos(c))
            b2b=pos[1] - int(l*r*math.sin(c))
            pygame.draw.circle(self.surface, (0,255,0), (b1a, b2a), 2*r, 2)
            pygame.draw.circle(self.surface, (0,255,0), (b1b, b2b), 2*r, 2)
    ...
    def dibrotacion(self, pos, R, orientacion, dm1, dm2):
        ...
        b2b=pos[1] - int(l*r*math.sin(c))
        if dm1==1:
            pygame.draw.circle(self.surface, (0,255,0), (b1b, b2b), 2*r, 1) 
        elif dm1==0:
            pygame.draw.circle(self.surface, (0,255,0), (b1a, b2a), 2*r, 1) 
