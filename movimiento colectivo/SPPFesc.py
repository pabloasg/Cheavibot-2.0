...
este archivo se llama Fesc (por final y escritura), es un archivo final que contiene las 3 reglas, se ejecuta de manera continua
este archivo permite tanto guardar imagenes como datos en un archivo csv
'''
...
p=0
#ciclo while
with open('movF.csv', 'w', newline='') as f: 
    while True:
        p=p+1
        contador=0
        cc=[]
        ...
        #codigo para escribir datos en el archivo csv
        cor=[]
